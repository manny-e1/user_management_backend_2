  ...
  try {
    await db
      ...
      .set({
        ...
        iRakyatStatus: sql`CASE WHEN "iRakyatYN" IS TRUE AND "approvalStatus" IS 'Approved' THEN (CASE WHEN "iRakyatStatus"='C' THEN 'C' ELSE 'A' END) ELSE '' END`,
        iBizRakyatStatus: sql`CASE WHEN "iBizRakyatYN" IS TRUE AND "approvalStatus" IS 'Approved' THEN (CASE WHEN "iBizRakyatStatus"='C' THEN 'C' ELSE 'A' END) ELSE '' END`,
